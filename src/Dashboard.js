...
const Dashboard = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get('https://supril-be.vercel.app/persons', { headers });
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://supril-be.vercel.app/persons/${id}`);
  ...
  const handleAddPerson = async (newPersonData) => {
    try {
      await axios.post('https://supril-be.vercel.app/persons', newPersonData);
  ...
  const handleUpdate = async (id, updatedPersonData) => {
   try {
      await axios.put(`https://supril-be.vercel.app/persons/${id}`, updatedPersonData);
